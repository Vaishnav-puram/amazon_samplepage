        ...
        <div className="Grid">
            <div className="main">
                ...
                <div className="obj">
                    ...
                    {props.ele.rating > 4 && <div className="reviews"><div className="stars"><MdOutlineStarPurple500 /><MdOutlineStarPurple500 /><MdOutlineStarPurple500 /><MdOutlineStarHalf /></div><div className="rating"> {props.ele.reviews}</div></div>}
                    {props.ele.rating < 3 && <div className="reviews"><div className="stars"><MdOutlineStarPurple500 /><MdOutlineStarPurple500 /><MdOutlineStarHalf /></div><div className="rating"> {props.ele.reviews}</div></div>}
                    {props.ele.rating === 3 && <div className="reviews"><div className="stars"><MdOutlineStarPurple500 /><MdOutlineStarPurple500 /><MdOutlineStarPurple500 /></div><div className="rating"> {props.ele.reviews}</div></div>}
